...
@Slf4j
@Repository
public class CmOracleDao extends SqlSessionDaoSupport {
	//mapper(xml) default package
	private final static String _query_path = "com.demo.administrator.mappers.oracle.";
	
	@Override
	@Resource(name = "SqlSessionFactoryForOracle")
	public void setSqlSessionFactory(SqlSessionFactory sqlSessionFactory) {
		super.setSqlSessionFactory(sqlSessionFactory);
	}

	@Override 
	@Resource(name = "SqlSessionTemplateForOracle")
